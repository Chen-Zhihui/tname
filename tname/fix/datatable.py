...
from solara.datatypes import CellAction, ColumnAction
...
class DataTableWidget(v.VuetifyTemplate):
    ...
    def vue_on_column_action(self, data):
        ...
        # if isinstance(data, dict):
        #     on_click = self._column_actions_callbacks[data[action_index]]
        #     if on_click:
        #         on_click(data[header_value])
        # else:
        if 1:
    ...
    def vue_on_cell_action(self, data):
        ...
        # if isinstance(data, dict):
        #     on_click = self._cell_actions_callbacks[data[action_index]]
        #     if on_click:
        #         on_click(data[header_value], data[row])
        # else:
        if 1:
